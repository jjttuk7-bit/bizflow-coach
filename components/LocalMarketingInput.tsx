    ...
    return (
        <div className="w-full max-w-2xl mx-auto p-8 bg-linen rounded-sm animate-fade-in space-y-6 relative border border-rule">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label htmlFor="targetArea" className="block text-lg font-medium text-ink">
                        홍보 대상 지역
                    </label>
                ...
                <div>
                    <label htmlFor="targetCustomer" className="block text-lg font-medium text-ink">
                        핵심 타겟 고객
                    </label>
                    <p className="text-xs text-slate-ink mb-2">
                 ...
                 <div>
                    <label htmlFor="goal" className="block text-lg font-medium text-ink">
                        마케팅 목표
                    </label>
                    <p className="text-xs text-slate-ink mb-2">
                ...
                <div>
                    <label htmlFor="budget" className="block text-lg font-medium text-ink">
                        예상 월 예산 (선택)
                    </label>
                    <p className="text-xs text-slate-ink mb-2">
