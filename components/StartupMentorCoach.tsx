...
const StartupMentorCoach: React.FC<StartupMentorCoachProps> = ({ specialist, onBack, specialists }) => {
    ...
    const renderInputStage = () => (
        <div className="space-y-4">
            ...
            <textarea
                ...
                className="block w-full p-3 bg-slate-50 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
    ...
    const renderAnalyzingStage = () => (
        <div className="flex flex-col items-center justify-center text-center h-48">
            ...
            <p className="mt-4 text-lg text-gray-700">이든 멘토가 사장님의 사업 계획을 꼼꼼히 분석하고 있습니다...</p>
    ...
    const renderResultStage = () => (
        <div className="space-y-6">
            <div className="p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
                <h3 className="text-lg font-bold text-indigo-800">사장님의 사업 계획을 위한 맞춤 멘토링</h3>
                <p className="mt-1 text-sm text-indigo-700">아래 10가지 핵심 원칙에 따라 사장님의 아이디어를 분석하고 조언을 정리했습니다. 각 항목을 눌러 확인해보세요.</p>
            </div>
