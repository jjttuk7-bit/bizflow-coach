    ...
    return (
        <div className="w-full max-w-2xl mx-auto p-8 bg-linen rounded-sm animate-fade-in space-y-6 relative border border-rule">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label htmlFor="storeSize" className="block text-lg font-medium text-ink">
                        매장 평수와 형태
                    </label>
                ...
                <div>
                    <label htmlFor="storeLayout" className="block text-lg font-medium text-ink">
                        현재 매장 구조
                    </label>
                    <p className="text-xs text-slate-ink mb-2">
                 ...
                 <div>
                    <label htmlFor="goals" className="block text-lg font-medium text-ink">
                        공간을 통해 이루고 싶은 목표
                    </label>
                    <p className="text-xs text-slate-ink mb-2">
