...
const BusinessProfileSetup: React.FC<BusinessProfileSetupProps> = ({ onSave, initialDescription }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-8 bg-white rounded-xl shadow-lg space-y-6 animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          {isEditMode && (
            <div className="my-3 p-3 bg-yellow-50 border border-yellow-300 rounded-md text-sm text-yellow-800">
                <p>
                ...
                <button
                    ...
                    className="mt-2 px-3 py-1 bg-yellow-400 text-yellow-900 font-semibold rounded-md hover:bg-yellow-500 text-xs shadow-sm"
                >
                    수정된 정보 불러오기
                </button>
            </div>
