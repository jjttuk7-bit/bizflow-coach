    ...
    return (
        <div className="w-full max-w-2xl mx-auto p-8 bg-linen rounded-sm animate-fade-in space-y-6 relative border border-rule">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label htmlFor="objective" className="block text-lg font-medium text-ink">
                 ...
                 <div>
                    <label htmlFor="cost" className="block text-lg font-medium text-ink">
                 ...
                 <div>
                    <label htmlFor="competition" className="block text-lg font-medium text-ink">
                        [2단계] 경쟁 가게는 어떤가요?
                    </label>
                    <p className="text-xs text-slate-ink mb-2">
                 ...
                 <div>
                    <label htmlFor="customer" className="block text-lg font-medium text-ink">
